class AddRegulatorRoleSeeder < Germinator::Seed
  ...
  def germinate
    Role.create!([
    {
      ...
      role_permissions_attributes: [
        { permission_id: 1 }, { permission_id: 7 }, { permission_id: 8 }, { permission_id: 9 },
        { permission_id: 10 }, { permission_id: 11 }, { permission_id: 12 }, { permission_id: 13 },
        { permission_id: 14 }, { permission_id: 15 }
      ]
    }
    ])
  end
